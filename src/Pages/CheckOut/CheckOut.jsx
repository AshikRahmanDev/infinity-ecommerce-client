...
const CheckOut = () => {
  ...
  return (
    <div className="w-[90%] md:w-[75%] mx-auto mt-6 p-2">
      <h1 className="text-3xl text-center logo-font">Checkout</h1>
      <div className="my-5 md:flex justify-between w-[100%] gap-10">
        {/* details form */}
        <div className="logo-font md:w-[50%]">
        ...
        <div className="p-4 md:w-[40%] bg-gray-300/30">
